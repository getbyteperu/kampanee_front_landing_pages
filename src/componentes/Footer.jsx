  ...
  return (
    <div className="cont-footer">
      <section className="w-100 help mt-5 d-flex justify-content-center align-items-center flex-column mb-5">
        ...
        <img src={Help} className="help-img mt-4"  alt=""/>
        <img src={HelpResponsive} className="help-movil mt-4" alt=""/>
      </section>
        ...
        <div className="row">
          <div className="col-md-6 d-flex justify-content-center">
            <div className="asesor-1 d-flex justify-content-center">
              <img src={Asesoria1} className="asesoria" alt=""/>
              <img src={Asesor1} alt="" />
            </div>
            <button className="wsp-asesores"><img src={Whts} className="p-1 mx-1" alt="" />Asesor Kampanee</button>
          </div>
          <div className="col-md-6 d-flex justify-content-center">
            <div className="asesor-2 d-flex justify-content-center">
              <img src={Asesoria2} className="asesoria" alt="" />
              <img src={Asesor2} alt="" />
            </div>
            <button className="wsp-asesores"><img src={Whts}  className="p-1 mx-1" alt=""/>Dr. Kampanee</button>
          </div>
        </div>
      </section>
      <section className="banner">
        <div className="row cont-banner">
          ...
          <div className="col-md-6 footer-right">
            ...
            <img src={props.banner2} className="banner-2" alt=""/>
            <img src={Google} className="google-responsive" alt="" />
          </div>
        </div>
      </section>
      <footer className="footer mb-2 mx-5">
        <div className="row">
          <div className="col">
            <img src={Kampanee} className="logo-footer" alt=""/>
          </div>
          <div className="col">
